    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="info" className="w-full">
        ...
        <TabsContent value="info" className="mt-4 space-y-4">
          <SectionErrorBoundary title="Erro ao carregar Informações do Processo">
        ...
        <TabsContent value="subprocessos" className="mt-4">
          <SectionErrorBoundary title="Erro ao carregar Subprocessos">
        ...
        <TabsContent value="tasks" className="mt-4">
          <SectionErrorBoundary title="Erro ao carregar Tarefas">
            <Card className="shadow-sm">
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-lg flex items-center gap-2">
                            ...
                            <div className="text-xs text-muted-foreground flex items-center gap-2 mt-1">
                              ...
                              {resp && (
                                <span className="bg-slate-100/50 px-1.5 py-0.5 rounded text-[10px]">
                                  Resp:{' '}
                                  <span className="font-medium">{resp.name.split(' ')[0]}</span>
                                </span>
                              )}
                            </div>
                          </div>
        ...
        <TabsContent value="agenda" className="mt-4">
          <SectionErrorBoundary title="Erro ao carregar Agenda">
            <Card className="shadow-sm">
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-lg flex items-center gap-2">
        ...
        <TabsContent value="despesas" className="mt-4">
          <SectionErrorBoundary title="Erro ao carregar Financeiro">
